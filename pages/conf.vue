<template>
  <div>
    ...
    <div class="conf">
      ...
      <p>L’adresse de notre site Web est&nbsp;:  <a href="http://winkle.fr/">http://winkle.fr</a> .</p>
      ...
      <p>Lors de l’utilisation des formulaires de contact, les messages sont transmis vers notre adresse pewpew.agency@gmail.com</p>
      <h3>Cookies</h3>
      ...
      <p>Nous utilisons le service Google Analytics à des fins de mesure d’audience. Ce site collecte des informations sur votre navigation dans le site.</p>
      ...
      <ul><li>Mail : pewpew.agency@gmail.com</li></ul>
      <h2>Informations supplémentaires</h2>
      <h3>Comment nous protégeons vos données</h3>
      <p>WINKLE est protégé contre les intrusions par différents systèmes informatiques. Nous mettons à jour régulièrement et imposons des mots de passe complexes à nos utilisateurs.</p>
      <h3>Procédures mises en œuvre en cas de fuite de données</h3>
      <p>En cas de fuite de données, nous vous en informerons par mail. Nous rappelons que nous ne stockons pas vos numéros de carte bancaire.</p>
      <h3>Les services tiers qui nous transmettent des données</h3>
      <p>Nous ne recevons de données d’aucun service tiers.</p>
      <h3>Opérations de marketing automatisé et/ou de profilage réalisées à l’aide des données personnelles</h3>
      <p>Nous n’utilisons pas de système de marketing automatisé.</p>
      <p>Nous ne réalisons pas de profilage.</p>
    </div>
    <footer class="footer">
