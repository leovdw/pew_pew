<template>
  <div>
    ...
    <div class="conf">
      ...
      <h2>Politique de confidentialité de winkle.fr</h2>
      <p>
      ...
      <p>
        ...
        Winkle <br>
        5 Rue Saint-Augustin, 75002 Paris <br>
        <br>
        Courriel de contact du Propriétaire : wearewinkle@gmail.com
      </p>
      ...
      <p>
        ...
        le traitement est lié à une tâche effectuée dans l'intérêt public ou dans l'exercice de l'autorité publique dévolue au Propriétaire ; <br>
        ...
        <h3>
        Lieu de traitement</h3>
        <p>
        Les Données sont traitées au siège du Propriétaire et dans tous les autres lieux où sont situées les parties responsables du traitement. <br>
        ...
        Les Données relatives à l’Utilisateur sont collectées afin de permettre au Propriétaire de fournir ses Services, ainsi que pour les finalités suivantes : Analyses, Gestion des contacts et envoi de messages, Gestion des balises et Carte de chaleur et enregistrement de sessions.
        ...
        <h2>Les Données personnelles sont collectées pour les finalités suivantes à l'aide de plusieurs services :</h2>
        <br>
        <h3>Analyses :</h3>
        ...
        Lieu de traitement : États-Unis – Politique de confidentialité. Participant au bouclier de protection des données.</p>
